...
function seleccionar_cabys(valor) {
    ...
    $('#' + form_activo).find('.category_code').val(cabys[valor].codigo);
    $('#' + form_activo).find('.category_suggestedTax').val(cabys[valor].impuesto);
    $('#' + form_activo).find('.category_description').val(cabys[valor].descripcion);
