...
function ver_factura(id_factura) {
    ...
    if ($("#" + factura).length == 0 || $("#" + factura).is(":empty")) {
        ...
        $(".btn-factura")
            .removeClass("btn-success btn-warning btn-danger btn-secondary btn-purple btn-info")
            .addClass("btn-dark");
        ...
        //Mostrar ek boton de referencias
        $(".col-referencia").show();
 ...
 */
function descargarArchivo(url, fileName, extension = "pdf") {
