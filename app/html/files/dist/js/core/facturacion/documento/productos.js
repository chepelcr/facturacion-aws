...
function seleccionar_producto(id_producto, boton_producto) {
    const linea_producto = $(boton_producto).parents(".producto");
    ...
    $.ajax({
        ...
        .fail(function (jqXHR, textStatus, errorThrown) {
            if (jqXHR.responseText != undefined && jqXHR.responseText != null && jqXHR.responseText != "") {
                ...
                json = { error: "Error al seleccionar el producto" };
            }
...
function buscar_producto() {
    //boton, gnl = "", agregar = false) {
    let gnl = $("#" + factura_activa)
        .find(".gnl-agregar")
        .val();
