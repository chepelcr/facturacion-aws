    ...
    Pace.track(function () {
      $.ajax({
        ...
        if (response.validar_estado == "procesando") {
          ...
          mensaje =
            "El documento esta siendo procesado por el Ministerio de Hacienda";
        }
        Swal.fire({
          title: "Atencion",
          text: mensaje,
    ...
    $.ajax({
      ...
      if (!response.error) {
        ...
        if (response.validar_estado == "error") {
          response.estado = "error";
          mensaje =
            "El documento no ha podido ser validado por el Ministerio de Hacienda, debe intetarlo mas tarde";
        }
