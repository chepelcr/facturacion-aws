        ...
        <div class="row d-flex justify-content-between">
            ...
            <div class="col-md-4">
                <div class="row">
                    ...
                    <!-- Agregar descuento -->
                    <div class="col-md-3">
                        <button type="button" class="btn btn-outline-primary btn-sm btn-block" onclick="agregar_descuento(this)" data-toggle="tooltip" title="Agregar descuento">
                ...
                <tr class="discountLine">
                    <td colspan="4">
                        <div class="row">
                            ...
                            <div class="col-1">
                                <div class="form-group">
                                    <button type="button" class="btn btn-outline-danger btn-sm btn-block btn-dlt" disabled onclick="eliminar_descuento(this)">
