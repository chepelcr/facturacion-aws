<div class="modal fade modal-walmart" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
            ...
            <div class="modal-body">
                <div class="row contenedor-datos">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control inp-fct form-control-sm numero_vendor" name="otherFields[0][otherText]">
                                ...
                                <input type="hidden" value="WMNumeroVendedor" name="otherFields[0][code]">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12" hidden>
                        <input type="text" class="form-control inp-fct enviar_gln" name="otherFields[1][otherText]">
                        <input type="hidden" value="WMEnviarGLN" name="otherFields[1][code]">
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control inp-fct numero_orden" max="8" min="8"
                                    placeholder="Ingrese el numero de orden" name="otherFields[2][otherText]">
                                <input type="hidden" value="WMNumeroOrden" name="otherFields[2][code]">
                            </div>
                        </div>
                    </div>
                </div>
