<div class="modal fade" id="modalProductos" tabindex="-1" aria-labelledby="titulo" aria-hidden="true" data-keyboard="false" data-backdrop="static">
                                        ...
                                        <form id="frmBusquedaProductos">
                                            <div class="input-group">
                                                ...
                                                <input type="search" class="form-control form-control-sm"
                                                    placeholder="Nombre o codigo del producto" id="q_productos">
