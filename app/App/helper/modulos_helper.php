...
/**
 * Funcion para obtener los modulos del usuario que ha iniciado sesion
 * @return array Modulos del usuario
 */
function getModulos()
{
...
/**
 * Validar si el usuario tiene permiso para acceder a un modulo
 * @param string $v_modulo Nombre del modulo
 * @param string $v_objeto Nombre del objeto
 * @param string $v_accion Nombre de la accion
 * @return boolean True si tiene permiso, false si no tiene permiso
 */
...
/**
 * Obtener los botones de una tabla
 * @param int $v_id Id del registro
 * @param string $v_objeto Nombre del objeto
 * @param string $v_modulo Nombre del modulo
 * @param string $v_submodulo Nombre del submodulo
 * @param string $v_estado Estado del registro
 * @return string Botones de la tabla
 */
...
/**
 * Formatear una cedula para mostrarla en pantalla
 * @param string $cedula Cedula a formatear
 * @param string $tipo_cedula Tipo de cedula
 * @return string Cedula formateada
 */
...
/**
 * Eliminar el formato de una cedula
 * @param string $cedula Cedula a desformatear
 * @return string Cedula desformateada
 */
