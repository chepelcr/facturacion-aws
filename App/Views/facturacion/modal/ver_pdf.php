    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <iframe id="ticketIframe" name="ticketIframe" src="<?= $documentUrl ?>" style="border:none; width:100%; height:65vh;" title="PDF Document" referrerpolicy="origin-when-cross-origin"></iframe>
            </div>
