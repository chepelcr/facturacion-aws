            ...
            <tbody>
                <form id="frm_reporte_documentos">
                    ...
                    foreach ($documentos as $key => $documento) :
                        $fecha = date('d/m/Y', strtotime($documento->saleDate));
                        //Obtener la fecha de inicio mas antigua en y-m-d
                        if ($key == 0) {
                            $startDate = date('Y-m-d', strtotime($documento->saleDate));
                        }
                        ...
                        <div class="col-md-2">
                            <div class="input-group">
                                ...
                                <select class="form-control form-control-sm" id="documentTypeId" name="documentTypeId" onchange="cargar_documentos('busqueda')">
                                    ...
                                    <?php var_dump($documentTypes);
                                    foreach ($documentTypes as $tipo_documento) :
